...
const AddNewInvoice = () => {
    ...
    return (
        <div className='mt-8 text-xl'>
            <div className="w-full max-w-2xl mx-auto p-4 bg-white border border-gray-900 shadow-lg rounded-lg mt-5">
                <Formik
                    ...
                    {({ values }) => (
                        <Form className="space-y-4">
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                                <div>
                                    ...
                                    <Field
                                        ...
                                        name="name"
                                        placeholder="Name"
                                        className="mt-1 block w-full border p-2 border-black rounded-md shadow-sm" />
                                    ...
                                    {({ push, remove }) => (
                                        <div className="overflow-x-auto">
                                            ...
                                            <button
                                                ...
                                                className="mt-5 p-2 bg-green-600 text-white rounded-md hover:bg-green-700"
                                            >
                                                Add Product
                                            </button>
                                        </div>
                            ...
                            <div className="mt-4 text-lg font-semibold text-gray-900">
                                Total Bill: {values.products.reduce((acc, product) => acc + (product.quantity * product.price), 0).toFixed(2)}
                            </div>
