...
function ViewInvoice() {
    return (
        <div className='flex justify-center '>
            ...
            <div className=' border-2 border-gray-400 rounded h-[550px] w-[810px] p-2 shadow-2xl shadow-slate-500'>
                ...
                <div className='flex gap-3 flex-col border-black border-b-2 drop-shadow-2xl shadow shadow-black '>
                    <div className=' text-2xl'>
                        Invoice Id : <span className='p-1'>
                            1243
                        </span>
                    </div>
                    <div className='text-2xl'>
